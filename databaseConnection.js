...
const hostedURI = `mongodb+srv://${process.env.REMOTE_MONGODB_USER}:${process.env.REMOTE_MONGODB_PASSWORD}@${process.env.REMOTE_MONGODB_HOST}/${databaseName}?retryWrites=true&w=majority`
